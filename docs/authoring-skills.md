...
`.opencode/skills/`. Skills define structured workflows that agents
...
4. Run the relevant project or plugin tests for the changed skill.

For skills that affect the OpenCode runtime, verify the referenced agents and
commands exist before completing the change.
