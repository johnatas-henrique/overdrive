...
> **Estimate**: 5 stories (~7.5h active — calibrated 0.3×, sprint-3 retrospective)
...
|---|-------|------|--------|-----|
| 001 | Lift-Off Rotation & Tuck-In | Logic | Ready | ADR-0002 |
| 002 | Drift Factor (track-radius) | Logic | Ready | ADR-0002 |
| 003 | Real-Engine Longitudinal Formula | Logic | Ready | ADR-0002 |
| 004 | Telemetry Contracts | Integration | Ready | ADR-0014, ADR-0010, ADR-0012 |
| 005 | Dev Playtest Rig | Integration | Ready | ADR-0001, ADR-0002, ADR-0003 |

*Note: 5 stories (not 4) — QL-STORY-READY 2026-08-16 mandated splitting telemetry/rig (004/005) and deferring the CP1/CP2 car-stat benchmark to the rig evidence (cross-epic).*