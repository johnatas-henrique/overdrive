...
| Vehicle Physics — Dynamics | Core | Vehicle Physics | design/gdd/vehicle-physics.md | Not yet created | Ready — S1·F1, est. 4 stories, ADR-0002/0001, kernel step 6 |
| Vehicle Physics — Feel & Telemetry | Core | Vehicle Physics | design/gdd/vehicle-physics.md | Not yet created | Ready — S1·F1, est. 4 stories, ADR-0002/0014/0010, telemetry contract + dev rig |
| Race Flow | Core | RSM + Qualifying + Grid & Start | design/gdd/race-session-manager.md + qualifying.md + grid-start.md | Not yet created | Ready — S1·F2, est. 5 stories, ADR-0018/0013, kernel steps 9/10 |
| AI Rival | Core | AI Rival | design/gdd/ai-rival.md | Not yet created | Ready — S1·F3, est. 4 stories, ADR-0009, kernel step 13 |
| Track | Core | Track | design/gdd/track-system.md | Not yet created | Ready — S2·F1, est. 3 stories, ADR-0007, 4 MVP tracks |
| Car Definition Data | Core | Car Definition Data | design/gdd/car-definition-data.md | Not yet created | Ready — S2·F1, est. 3 stories, ADR-0015, 16 teams |
| Race Strategy | Core | Fuel + Tire + Pit Stop | design/gdd/fuel-system.md + tire-system.md + pit-stop.md | Not yet created | Ready — S2·F2, est. 4 stories, ADR-0006/0011, kernel steps 5a/5b/9b |
| Camera | Core + Presentation | Camera | design/gdd/camera.md | Not yet created | Ready — S2·F3, est. 2 stories, ADR-0010 |
| HUD | Core + Presentation | HUD | design/gdd/hud.md | Not yet created | Ready — S2·F3, est. 3 stories, ADR-0014 |
| Audio | Core + Presentation | Audio | design/gdd/audio-system.md | Not yet created | Ready — S2·F3, est. 3 stories, ADR-0012 |
| VFX | Presentation | VFX | design/gdd/vfx.md | Not yet created | Ready — S2·F3, est. 2 stories, ADR-0010 |
| UI Menu | Presentation | UI Menu | design/gdd/ui-menu.md | Not yet created | Ready — S2·F4, est. 4 stories, ADR-0019, production bootstrapper (TD-038) |
...
**Next steps:**
- **Core layer epics READY (12/12 created 2026-08-16)** — estimates in stories (calibrated 0.3×); 2-orchestrator plan at `docs/plans/sprint4-mvp-flow-2026-08-16.html`. Next: `/create-stories` per epic, then `/sprint-plan` for Phase 1 (Vehicle Physics S1 · Track + CarDef S2).
