...
> **Status**: Ready
> **Stories**: 4 stories created (2 Logic, 2 Integration) — see table below
> **Estimate**: 4 stories (~6h active — calibrated 0.3×, sprint-3 retrospective)
...
|---|-------|------|--------|-----|
| 001 | CarDefinition Data Model & Stat Formulas | Logic | Ready | ADR-0015 |
| 002 | Load-Time Validation | Logic | Ready | ADR-0015 |
| 003 | Editor Differentiation Validator | Integration | Ready | ADR-0015 |
| 004 | Car Asset Authoring & Addressables Integration | Integration | Ready | ADR-0015 |

*Note: 4 stories (not 3) — QL-STORY-READY 2026-08-16 mandated splitting differentiation/authoring; known data issues (duplicate profiles, tier-average discrepancy) documented in story 004.*