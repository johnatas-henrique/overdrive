...
| ID | SMGP Team | Based On (1989) | Car | Primary | Hex | Secondary | Hex | Notes |
|----|-----------|-----------------|-----|---------|-----|-----------|-----|-------|
| `team_tier2_a` | **May** | March-Leyton House-Judd | CG891 | Miami Blue | `#66C5C5` | Green | `#2E7D32` | "Leyton blue" — the dominant pastel turquoise body color. Green accents come from BP co-sponsorship. Exposed carbon/black aerodynamic parts are functional, not team colors. White is limited to small period markings or reflections; it is not a broad body-panel color. No large white sidepod or wing panels. Designer Adrian Newey's first F1 car. [ultimatecarpage](https://www.ultimatecarpage.com/car/7680/March-CG891-Judd.html) |
