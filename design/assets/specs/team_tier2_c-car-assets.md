...
> **Team**: Tyrant (team_tier2_c)
> **Car Reference**: Tyrrell 017B/018
...
## ASSET-001 — Car: Tyrant (Tyrrell 017B/018 Parody)

| Field | Value |
|-------|-------|
| Category | 3D Asset (Reference) |
| Team ID | team_tier2_c |
| Car Reference | Tyrrell 017B/018 |
| Real-World Team | Tyrrell-Ford |
| Livery Base | Tyrrell Blue body with Yellow and White accents |
...
| Reference Photo | https://en.wikipedia.org/wiki/Tyrrell_018 |
...
| Texture | Assets/Art/Cars/tier2c/Textures/ |
| Material | Assets/Art/Cars/tier2c/Materials/ |
| Prefab | Assets/Art/Cars/tier2c/Prefabs/ |

### Art Bible Anchors

- §2.2 Team Identity: Primary #1E4D8C (Tyrrell Blue), Secondary #F5C518 (Yellow) + #FFF8F0 (White)
...
Tyrrell Blue (#1E4D8C) body covering the monocoque, nose cone, sidepods, engine cover, and front wing mainplanes — approximately 65% of visible surface. White (#FFF8F0) covering the sidepod lower half, rear wing mainplane and endplates, front wing endplates, and a thin stripe along the engine cover — approximately 35%. The defining visual element is the deep Tyrrell Blue body with generous white accent panels creating a classic blue and white racing livery. Clean, sculpted sidepod inlet shapes. Open wheels with visible double-wishbone suspension arms. No wheel covers — brake discs visible behind spokes.
...
```
Kosuke Fujishima and Hino Matsuri fusion style, driver's eye view from inside the cockpit of a 1989 Tyrrell 017B/018 Formula 1 car. A round 3-spoke black suede Jack Knight steering wheel dominates the center of the frame — it is the main focal point. The rim is thin suede with 4 silver hex bolts on the hub, bearing the Jack Knight brand logo. Through the upper opening of the steering wheel, visible on the dark matte carbon fiber dashboard behind it, sits a Stack analog tachometer — a traditional circular gauge with a black face, white markings around the perimeter, and a thin red sweeping needle, the Stack brand identifiable by its distinctive instrument styling and precise numbering. Small analog auxiliary gauges for water temperature and oil pressure are mounted below. The most distinctive feature: mounted on the upper spokes of the steering wheel hub are small red LED shift lights — a row of indicator lamps added mid-season for Jean Alesi, designed to catch the driver's peripheral vision at the optimal shift point, an early innovation that became characteristic of the Tyrrell cockpit. One small green indicator light at top-left. One small red push-button at bottom-right. A metallic spherical gear knob on a short H-pattern 6-speed lever to the right. Carbon fiber monocoque walls with Tyrrell Blue and white livery panels. Two rectangular side mirrors with orange trim. Simple, cramped cockpit — the Tyrrell was known for its snug driver fit. No driver, no helmet, no hands. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```

#### Prompt 7 — Cockpit POV (Helmet Cam, Slightly Elevated)

```
Kosuke Fujishima and Hino Matsuri fusion style, helmet camera view from inside the cockpit of a 1989 Tyrrell 017B/018 Formula 1 car, slightly elevated looking down and forward. The round 3-spoke black suede Jack Knight steering wheel with 4 silver hex bolts fills the lower half — it is the dominant element. Through the upper opening of the wheel rim, visible on the dark matte dashboard: a Stack analog tachometer with a traditional circular gauge face, black background, white numbered markings, and a thin red mechanical needle. Small analog auxiliary gauges below. The most visually distinctive feature is the row of small red LED shift lights mounted on the upper steering wheel spokes between the grip and the hub — visible at the top of the wheel, these lights were a mid-season addition for Jean Alesi and became a signature of the Tyrrell cockpit. One green indicator light. One red push-button. Red seat bolsters. Carbon fiber floor with metallic 6-speed gear knob on the right. Transparent windscreen at top. Tire tread visible above cockpit. Tyrrell Blue and white livery panels. No driver, empty cockpit. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```

#### Prompt 8 — Cockpit Interior Reference (Empty, Diagonal Above)

```
Kosuke Fujishima and Hino Matsuri fusion style, looking down into the empty open cockpit of a 1989 Tyrrell 017B/018 Formula 1 car from above-left diagonal angle. The round 3-spoke black suede Jack Knight steering wheel is the largest element, mounted on the steering column. On the dark trapezoidal carbon fiber dashboard behind the wheel: a Stack analog tachometer with traditional circular gauge face, black background, white markings, and thin red needle — a classic analog instrument. Small auxiliary analog gauges for water temperature and oil pressure below. Visible on the steering wheel upper spokes is the row of small red LED shift lights — the most distinctive Tyrrell cockpit feature, added mid-1989 for Alesi. One green indicator light at top-left. One red push-button at bottom-right. H-pattern 6-speed gear lever with metallic spherical knob on the right. Black carbon fiber seat with red bolsters. Cramped cockpit walls with Tyrrell Blue and white livery — a snug, functional monocoque from a small team. Transparent windscreen. Two rectangular side mirrors with orange trim. No driver, no helmet, no hands. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```
...
- **Addressables Group**: Cars/team_tier2_c
