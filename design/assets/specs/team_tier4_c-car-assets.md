...
> **Team**: Orchis (team_tier4_c)
> **Car Reference**: Onyx ORE-1
...
## ASSET-001 — Car: Orchis (Onyx ORE-1 Parody)

| Field | Value |
|-------|-------|
| Category | 3D Asset (Reference) |
| Team ID | team_tier4_c |
| Car Reference | Onyx ORE-1 |
| Real-World Team | Onyx-Ford |
| Livery Base | Onyx Blue body with Pink and White accents |
...
| Reference Photo | https://f1colours.sebpatrick.co.uk/teams/onyx/ |
...
| Texture | Assets/Art/Cars/tier4c/Textures/ |
| Material | Assets/Art/Cars/tier4c/Materials/ |
| Prefab | Assets/Art/Cars/tier4c/Prefabs/ |

### Art Bible Anchors

- §2.2 Team Identity: Primary #1A2A5C (Onyx Blue), Secondary #E87A90 (Pink) / #FFF8F0 (White)
...
Onyx Blue (#1A2A5C) body covering the monocoque, nose cone, sidepods, and engine cover — approximately 55% of visible surface. Pink (#E87A90) covering the sidepod lower panels, a bold longitudinal stripe on the engine cover, and a stripe across the nose cone — approximately 25%. White (#FFF8F0) on the front wing endplates, rear wing mainplane, rear wing endplates, and small accent panels — approximately 20%. The defining visual element is the deep Onyx Blue body with contrasting pink panels and white accents creating a distinctive, unusual livery. Clean, sculpted sidepod inlet shapes. Open wheels with visible double-wishbone suspension arms. No wheel covers — brake discs visible behind spokes.
...
```
Kosuke Fujishima and Hino Matsuri fusion style, driver's eye view from inside the cockpit of a 1989 Onyx ORE-1 Formula 1 car — notable for its controversial Moneytron sponsorship. A round 3-spoke black suede Onyx-branded generic steering wheel dominates the center of the frame, the Onyx team logo at the hub. The rim is thin suede with 4 silver hex bolts. Through the upper opening of the steering wheel, visible on the dark matte carbon fiber dashboard behind it, sits a conventional analog tachometer — a round gauge with a black face, white markings, and a thin red sweeping needle. Below the tachometer are simple analog auxiliary gauges for oil pressure and water temperature — basic round dials with black faces and thin needles. All analog instrumentation, no digital displays — functional and straightforward, reflecting the small British team's practical approach. The gearbox was an XTrac unit. One small green indicator light at top-left. One small red push-button at bottom-right. A metallic spherical gear knob on a short H-pattern 6-speed lever to the right. Carbon fiber monocoque walls with Onyx Blue and pink livery panels. Two rectangular side mirrors with orange trim. Compact cockpit opening — the Onyx ORE-1 featured a clean, minimal cockpit area. No driver, no helmet, no hands. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```

#### Prompt 7 — Cockpit POV (Helmet Cam, Slightly Elevated)

```
Kosuke Fujishima and Hino Matsuri fusion style, helmet camera view from inside the cockpit of a 1989 Onyx ORE-1 Formula 1 car, slightly elevated looking down and forward. The round 3-spoke black suede Onyx-branded steering wheel with 4 silver hex bolts fills the lower half — it is the dominant element, the Onyx logo at the hub center. Through the upper opening of the wheel rim, visible on the dark matte dashboard: a conventional analog tachometer with round black face, white markings, and red needle — a basic traditional gauge. Simple analog auxiliary gauges for oil pressure and water temperature below. The instrumentation is straightforward and functional, typical of a small independent team. The XTrac gearbox lever is on the right. One green indicator light. One red push-button. Red seat bolsters. Carbon fiber floor with metallic 6-speed gear knob on the right. Transparent windscreen at top. Tire tread visible above cockpit. Onyx Blue and pink livery panels. No driver, empty cockpit. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```

#### Prompt 8 — Cockpit Interior Reference (Empty, Diagonal Above)

```
Kosuke Fujishima and Hino Matsuri fusion style, looking down into the empty open cockpit of a 1989 Onyx ORE-1 Formula 1 car from above-left diagonal angle. The round 3-spoke black suede Onyx-branded steering wheel is mounted on the steering column, the Onyx team logo at the hub. On the dark trapezoidal carbon fiber dashboard behind the wheel: a conventional analog tachometer with round gauge face, black background, white markings, and red needle. Simple analog auxiliary gauges for oil pressure and water temperature below. All conventional analog instrumentation — no digital displays, reflecting the small team's practical and cost-conscious approach. The XTrac 6-speed gearbox lever sits on the right. One green indicator light at top-left. One red push-button at bottom-right. H-pattern 6-speed gear lever with metallic spherical knob on the right. Black carbon fiber seat with red bolsters. Compact cockpit walls with Onyx Blue and pink livery, the distinctive Moneytron sponsor colors visible on the bodywork. Transparent windscreen. Two rectangular side mirrors with orange trim. No driver, no helmet, no hands. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```
...
- **Addressables Group**: Cars/team_tier4_c
