...
> **Team**: Linden (team_tier3_b)
> **Car Reference**: Ligier JS33
...
## ASSET-001 — Car: Linden (Ligier JS33 Parody)

| Field | Value |
|-------|-------|
| Category | 3D Asset (Reference) |
| Team ID | team_tier3_b |
| Car Reference | Ligier JS33 |
| Real-World Team | Ligier-Ford |
| Livery Base | Solid Gitanes Blue body |
...
| Reference Photo | https://f1colours.sebpatrick.co.uk/teams/ligier/ |
...
| Texture | Assets/Art/Cars/tier3b/Textures/ |
| Material | Assets/Art/Cars/tier3b/Materials/ |
| Prefab | Assets/Art/Cars/tier3b/Prefabs/ |

### Art Bible Anchors

- §2.2 Team Identity: Primary #0D2B5E (Gitanes Blue), no secondary (solid livery)
...
Solid Gitanes Blue (#0D2B5E) body covering the monocoque, nose cone, sidepods, engine cover, front and rear wings, and endplates — approximately 90% of visible surface. The deep, rich blue is the defining visual identity — a uniform dark blue body with minimal sponsor decal interruptions. Small white rectangular sponsor decal panels on sidepods and nose cone sides. Clean, sculpted sidepod inlet shapes. Open wheels with visible double-wishbone suspension arms. No wheel covers — brake discs visible behind spokes.

Sponsor decals simulated as geometric color blocks (no text): small rectangular white panels on sidepod outer surfaces and a thin white stripe across the nose cone. No real brand logos.
...
```
Kosuke Fujishima and Hino Matsuri fusion style, driver's eye view from inside the cockpit of a 1989 Ligier JS33 Formula 1 car. A round 3-spoke black leather-and-suede PERSONAL steering wheel dominates the center of the frame — it is the main focal point. The rim is wrapped in smooth leather with suede grip sections, the PERSONAL crown logo badge centered on the hub with 4 silver hex bolts on the spokes. Through the upper opening of the steering wheel, visible on the dark matte carbon fiber dashboard behind it, sits a conventional analog tachometer — a full round gauge with a black face, white numbered markings around the perimeter, and a thin red sweeping needle, mounted centrally on the dashboard. Below the tachometer are smaller analog auxiliary gauges for water temperature and oil pressure — traditional round dials with black faces and thin needles, arranged in a compact row. All instruments are analog — no digital displays. One small green indicator light at top-left. One small red push-button at bottom-right. No extra switches. A metallic spherical gear knob on a short H-pattern 6-speed lever to the right — the gearbox was sourced from March. Carbon fiber monocoque walls with deep Gitanes Blue livery panels. Two rectangular side mirrors with orange trim. Standard narrow cockpit opening — the dark blue monocoque is compact and driver-focused. No driver, no helmet, no hands. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```

#### Prompt 7 — Cockpit POV (Helmet Cam, Slightly Elevated)

```
Kosuke Fujishima and Hino Matsuri fusion style, helmet camera view from inside the cockpit of a 1989 Ligier JS33 Formula 1 car, slightly elevated looking down and forward. The round 3-spoke black leather-and-suede PERSONAL steering wheel with crown logo and 4 silver hex bolts fills the lower half — it is the dominant element. Through the upper opening of the wheel rim, visible on the dark matte dashboard: a conventional full-round analog tachometer with black face, white numbers, and red sweeping needle — a traditional analog gauge. Below it, smaller analog auxiliary gauges for water temperature and oil pressure in a compact row. All analog instruments, no digital displays. The dashboard is functional and straightforward, matching Ligier's no-frills French engineering approach. One green indicator light. One red push-button. Red seat bolsters. Carbon fiber floor with metallic 6-speed gear knob on the right — the March-sourced gearbox. Transparent windscreen at top. Tire tread visible above cockpit. Deep Gitanes Blue livery panels. No driver, empty cockpit. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```

#### Prompt 8 — Cockpit Interior Reference (Empty, Diagonal Above)

```
Kosuke Fujishima and Hino Matsuri fusion style, looking down into the empty open cockpit of a 1989 Ligier JS33 Formula 1 car from above-left diagonal angle. The round 3-spoke black leather-and-suede PERSONAL steering wheel with crown logo is the largest element, mounted on the steering column. On the dark trapezoidal carbon fiber dashboard behind the wheel: a conventional full-round analog tachometer with black face, white numbers, and red needle — a traditional gauge. Below it, smaller analog auxiliary gauges for water temperature and oil pressure, all conventional round dials with black faces. All analog — no digital displays. One green indicator light at top-left. One red push-button at bottom-right. H-pattern 6-speed gear lever with metallic spherical knob on the right — sourced from March. Black carbon fiber seat with red bolsters. Narrow cockpit walls with deep Gitanes Blue livery, enclosing the driver in a tight carbon fiber tub. Transparent windscreen. Two rectangular side mirrors with orange trim. No driver, no helmet, no hands. Cel-shaded painted style, Fujishima and Matsuri fusion. 16:9 aspect ratio.
```
...
- **Addressables Group**: Cars/team_tier3_b
