...
14. Simulation resolves `ResolvedCarInput[carId]` for the next tick from the cached `AIInput` prepared by Step 13 and the latest captured raw sample, preparing the input contract consumed by Steps 5a/5b and 6 of the next tick.
