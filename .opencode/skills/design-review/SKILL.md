...
Use a third `question`:
 - Prompt: "May I write this review summary to `design/gdd/reviews/[doc-name]-review-log.md` by appending it? This creates a revision history so future re-reviews can track what changed."
