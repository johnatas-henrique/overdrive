...
- **PASS** — no open CRITICAL or HIGH findings remain.
- **CONCERNS** — only MEDIUM or LOW findings remain, or risks are explicitly accepted.
- **FAIL** — any CRITICAL or HIGH finding remains open, or the audit could not complete.
