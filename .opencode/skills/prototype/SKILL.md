...
_"Is this core idea actually fun to interact with?"_
...
> _"If the player [does X], they will feel [Y] — we will know this is true if [measurable signal Z]."_
...
- **Ink** (Inkle) — plain-text scripting language used in _80 Days_, _Heaven's Vault_, and _Overboard_; exports directly to Unity and Godot
- **Yarn Spinner** — dialogue scripting used in _A Short Hike_, _DREDGE_, and _Night in the Woods_; integrates natively with Unity and Godot
...
you validate whether your AI design _feels right_ before writing a single line of
...
- **Networked/multiplayer games:** A local prototype cannot validate the feel of a
  ...
  _interesting_. Do not use it as evidence that it _feels good_ under real network
