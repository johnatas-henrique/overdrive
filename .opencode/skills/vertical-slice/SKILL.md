...
_"Can we build this full game loop at production quality, on schedule?"_
...
> _"Does a player, starting from nothing, experience [core fantasy from game-concept.md]
> within [N] minutes, without developer guidance — and can we build one such loop
> in [X] days at representative quality?"_
...
This validates the _design intent_ of an AI or economy system before the implementation
...
Read `.opencode/docs/templates/vertical-slice-report.md` to get the report structure.
