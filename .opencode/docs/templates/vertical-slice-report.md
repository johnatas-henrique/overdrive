...
> _Vertical slice code location: `prototypes/[concept-name]-vertical-slice/`_
> _This code is reference material only. Production implementation is written from scratch._
> _Never import or refactor this code into production._
