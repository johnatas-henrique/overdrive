...
If no playtest sessions required: _No playtest sessions required for this sprint._
...
_Results and sign-off are tracked in the QA sign-off report generated by `/team-qa` — not in this plan file._

_Template: `.opencode/docs/templates/test-plan.md`_
_Generated by: `/qa-plan` — do not edit this line_
