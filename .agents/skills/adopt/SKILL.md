...
Classify the audit result explicitly:

- **READY** — no blocking or high-priority gaps remain.
- **CONCERNS** — only medium- or low-priority gaps remain.
- **BLOCKED** — at least one blocking gap remains.
