...
This skill does not write a report file by default. If a file report or any other
filesystem change is requested, present the exact path and ask, "May I write this
to [filepath]?" before writing.
