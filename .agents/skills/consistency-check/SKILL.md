...
Present all conflicts before changing the registry. For any requested correction,
ask, "May I write this to [filepath]?" and wait for approval before using `Write`
or `Edit`.
