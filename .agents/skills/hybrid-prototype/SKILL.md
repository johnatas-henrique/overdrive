...
**Execution status: COMPLETE** when the prototype has been playtested and a
decision has been recorded. The decision itself remains one of `ITERATE`,
`PIVOT`, `PRODUCTIONIZE`, or `KILL`.
